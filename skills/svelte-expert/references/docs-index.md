# Svelte MCP Documentation Index

This file provides an index of available Svelte documentation paths. You can use the `get-documentation` MCP tool with the paths listed below to retrieve specific domain knowledge. Minimize document requests to conserve token limits; rely on empirical knowledge first.
